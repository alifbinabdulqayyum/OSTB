...
if __name__ == "__main__":
    model = EDSR(n_inputs=1, n_feats=16, kernel_size=3, n_resblocks=16, bias=True, bn=False, act="relu", res_scale=1, scale=4, upsampling=True)
    x = torch.Tensor(16, 1, 75, 100)
    y = model(x)
    print(y.shape)
